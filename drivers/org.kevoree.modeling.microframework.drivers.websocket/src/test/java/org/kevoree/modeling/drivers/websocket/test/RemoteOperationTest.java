...
public class RemoteOperationTest {
    ...
    public void test() {
        ...
        model.setClassOperation(operationTrigger, new KOperation() {
            @Override
            public void on(KObject source, Object[] params, KCallback result) {
                if (result != null) {
                    result.on("Hello from " + source.toJSON());
                }
            }
        });
        ...
        model.connect(new KCallback() {
            ...
            public void on(Object o) {
                ...
                sensor.invokeOperationByName("trigger", new Object[]{"Hello"}, OperationStrategies.ONLY_ONE, new KCallback<String>() {
                    @Override
                            ...
                            public void on(Object o) {
                                modelClient.lookup(0, 0, sensorUUID, new KCallback<KObject>() {
                                    ...
                                    public void on(KObject kObject) {
                                        ...
                                        kObject.invokeOperationByName("trigger", new Object[]{"Hello"}, OperationStrategies.ONLY_ONE, new KCallback<String>() {
                                            @Override
                                            public void on(String o) {
                                                System.err.println("FromRemote,"+o);
                                            }
                                        });
    ...
    private int launchRunner(String file) {
        ...
        if (testNativeNode()) {
            try {
                ...
                String basePath = RemoteOperationTest.class.getClassLoader().getResource(file).getFile().replaceAll("%20", " ");
                params[1] = basePath;
