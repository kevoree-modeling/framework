...
class org.kubi.Group {
    att name : String
    ref* groupes : org.kubi.Group
    ref* devices : org.kubi.Device oppositeOf groupes
}

class org.kubi.Device {
    att id : String
    att homeId : String
    ref* groupes : org.kubi.Group oppositeOf devices
...
class org.kubi.Technology {
    att name : String
    ref* devices : org.kubi.Device oppositeOf technology
...
class org.kubi.Product {
    ...
    ref manufacturer : org.kubi.Manufacturer oppositeOf products
    ref* devices : org.kubi.Device oppositeOf productType
}
