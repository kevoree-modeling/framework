...
public class GenericObjectInfer extends AbstractKObjectInfer {
    ...
    public GenericObjectInfer(long p_universe, long p_time, long p_uuid, KMetaClass p_metaClass, KInternalDataManager p_manager, long currentUniverse, long currentTime,long currentUniverseMagic, long currentTimeMagic) {
