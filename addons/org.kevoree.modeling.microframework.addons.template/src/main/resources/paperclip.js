(function e(t, n, r) {
    ...
    }, {"../utils/bind": 70, "./base": 4, "protoclass": 79}],
    ...
    }, {"../utils/bind": 70, "./script": 15, "_process": 76}],
    ...
    24: [function (require, module, exports) {
        ...
        "./attributes/delete": 6,
        "./attributes/easeIn": 7,
        "./attributes/easeOut": 8,
        "./attributes/enable": 9,
        "./attributes/enter": 10,
        "./attributes/escape": 11,
        "./attributes/event": 12,
        "./attributes/focus": 13,
        "./attributes/style": 16,
        "./attributes/value": 17,
        "./components/repeat": 19,
        "./components/show": 20,
        "./components/stack": 21,
        "./components/switch": 22,
        "./components/unsafe": 23,
        "./runloop": 48,
        "_process": 76
    }],
            ...
            function parse(input) {
                var options = arguments.length > 1 ? arguments[1] : {},
                    ...
                    peg$c0 = function (children) {
                        return new RootNodeExpression(children);
                    },
                    peg$c1 = peg$FAILED,
                    peg$c2 = "<!DOCTYPE",
                    ...
                    peg$c10 = function (children) {
                        return new ArrayExpression(new ParametersExpression(trimTextExpressions(children)));
                    },
                    peg$c11 = "<!--",
                    ...
                    peg$c64 = function (info) {
                        return info;
                    },
                    peg$c65 = function (info) {
                        return new ElementNodeExpression(info.name, info.attributes);
                    },
                    ...
                    peg$c79 = function () {
                        return new StringExpression(trimNewLineChars(text()));
                    },
                    ...
                    peg$c85 = function (binding) {
                        return attrValues([binding]);
                    },
                    peg$c86 = "{{#",
                    peg$c87 = {type: "literal", value: "{{#", description: "\"{{#\""},
                    peg$c88 = function (blockBinding) {
                        return blockBinding;
                    },
                    ...
                    peg$c92 = function (blockBinding) {
                        return new RootNodeExpression(blockBinding);
                    },
                    peg$c93 = "{{/}}",
                    ...
                    peg$c180 = function () {
                        return {type: "infinity", value: Infinity};
                    },
                    peg$c181 = "null",
                    ...
                    peg$c197 = function (bindingType, reference, path) {
                        path = [reference].concat(path.map(function (p) {
                            return p[1];
                        }));
                    ...
                    peg$c209 = function (key) {
                        return key.value;
                    },
                    peg$c210 = function (key) {
                        return key;
                    },
...
// TODO: refactor me
    ...
    }, {"../utils": 72, "document-section": 77, "protoclass": 79}],
    ...
    }, {"../components/base": 18, "../utils/bind": 70, "../utils/extend": 71}],
...
// element.cloneNode(true), so we can't use that optimization.
    ...
    }, {"../../utils/async": 69, "_process": 76, "protoclass": 79}],
    ...
    }, {"../../../utils": 72, "../../../utils/bind": 70, "protoclass": 79}],
    ...
    }, {"../../../utils": 72, "./binding": 57, "protoclass": 79}],
    ...
    }, {"../../../utils": 72, "./attributesBinding": 63, "protoclass": 79}],
    ...
    }, {"../../../utils/extend": 71, "./attributesBinding": 63, "protoclass": 79}],
    65: [function (require, module, exports) {
        ...
        "../../../utils/set": 73,
        "../fragment": 67,
        "./attributeHydrator": 62,
        "./componentHydrator": 64,
        "./valueAttribute": 66,
        "protoclass": 79
    }],
