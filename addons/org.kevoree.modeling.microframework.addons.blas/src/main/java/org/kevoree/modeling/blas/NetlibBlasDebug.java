...
public class NetlibBlasDebug implements KBlas {
    ...
    public NetlibBlasDebug(){
        try{
            ...
            blasJava=load("com.github.fommil.netlib.F2jBLAS");
        }
        catch (Exception ex){
            ex.printStackTrace();
        }
            ...
            for (int n = (Math.min(paramInt1, paramInt2) - 1 + m) / m; n > 0; n--) {
                ...
                if ((j + k > paramInt2 ? 0 : 1) != 0) {
                    ...
                    if ((j + k > paramInt1 ? 0 : 1) != 0) {
                        ...
                        //blas.dgemm("No transpose", "No transpose", paramInt1 - j - k + 1, paramInt2 - j - k + 1, k, -1.0D, paramArrayOfDouble, j + k - 1 + (j - 1) * paramInt4 + paramInt3, paramInt4, paramArrayOfDouble, j - 1 + (j + k - 1) * paramInt4 + paramInt3, paramInt4, 1.0D, paramArrayOfDouble, j + k - 1 + (j + k - 1) * paramInt4 + paramInt3, paramInt4);
    ...
    public void dgemmj(KBlasTransposeType paramString1, KBlasTransposeType paramString2, int paramInt1, int paramInt2, int paramInt3, double paramDouble1, double[] paramArrayOfDouble1, int paramInt4, int paramInt5, double[] paramArrayOfDouble2, int paramInt6, int paramInt7, double paramDouble2, double[] paramArrayOfDouble3, int paramInt8, int paramInt9) {
        ...
        else
        {
            ...
            for (int i8 = (1 - i7 + -i5) / -i5; i8 > 0; i8--)
            {
                ...
                if ((m + n > paramInt1 ? 0 : 1) != 0) {
                    ...
                    //blas.dgemm("No transpose", "No transpose", paramInt1, n, paramInt1 - m - n + 1, -1.0D, paramArrayOfDouble1, (m + n - 1) * paramInt3 + paramInt2, paramInt3, paramArrayOfDouble2, m + n - 1 + paramInt5, i3, 1.0D, paramArrayOfDouble1, 1 - 1 + (m - 1) * paramInt3 + paramInt2, paramInt3);
