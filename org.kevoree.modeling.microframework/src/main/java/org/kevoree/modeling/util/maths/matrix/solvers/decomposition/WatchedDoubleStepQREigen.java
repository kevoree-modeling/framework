...
public class WatchedDoubleStepQREigen {
    ...
    private void addEigenvalue( double v ) {
        ...
        eigenvalues[numEigen].setValues(v,0);
        numEigen++;
        steps = 0;
        lastExceptional = 0;
    }

    private void addEigenvalue2arg( double v , double i ) {
        numStepsFind[numEigen] = steps;
        eigenvalues[numEigen].setValues(v,i);
        numEigen++;
        steps = 0;
        lastExceptional = 0;
    }
    ...
    public boolean isZero( int x1 , int x2 ) {
        ...
        return target <= 0.5* CommonOps.EPS*(above+right);
    }
    ...
    public void setup( DenseMatrix64F A ) {
        ...
        if( N != A.numRows ) {
            ...
            this.A.setMatrix(A);
            //UtilEjml.memset(numStepsFind,0,numStepsFind.length); by Assaad
        }
    ...
    public void implicitDoubleStep( int x1 , int x2 ) {
        ...
        performImplicitDoubleStep5arg(x1, x2, b11, b21, b31);
    }
    ...
    private void performImplicitDoubleStep5arg(int x1, int x2,
                                           double b11 , double b21 , double b31 ) {
        if( !bulgeDoubleStepQn6arg(x1, b11, b21, b31, 0, false) )
            return;
    ...
    public boolean createBulgeSingleStep( int x1 , double eigenvalue ) {
        ...
        double threshold = Math.abs(A.get(x1,x1))* CommonOps.EPS;

        return bulgeSingleStepQn5arg(x1,b11,b21,threshold,false);
    }
    ...
    public boolean bulgeDoubleStepQn( int i ) {
        ...
        double threshold = Math.abs(A.get(i,i))*CommonOps.EPS;

        return bulgeDoubleStepQn6arg(i + 1, a11, a21, a31, threshold, true);
    }

    public boolean bulgeDoubleStepQn6arg( int i ,
...
//
    ...
    public boolean bulgeSingleStepQn( int i )
    {
        ...
        return bulgeSingleStepQn5arg(i + 1, a11, a21, threshold, true);
    }

    public boolean bulgeSingleStepQn5arg( int i ,
...
//        System.out.printf("eigen (%6.3f , %6.3f) (%6.3f , %6.3f)\n",p0_real,p0_img,p1_real,p1_img);
    ...
    public void addComputedEigen2x2(int x1,int x2) {
        ...
        addEigenvalue2arg(valueSmall.value0.real, valueSmall.value0.imaginary);
        addEigenvalue2arg(valueSmall.value1.real, valueSmall.value1.imaginary);
    }
