...
public class OppositeTestDesactivated {
    ...
    public OppositeTestDesactivated() {
    ...
    public void A_singleRef() { // single ref, not contained, no apposite
        ...
        a.setRef(A_Class.reference("singleRef"), b, new KCallback() {
            @Override
                            ...
                            public void on(Object o) {
                                a.ref(A_Class.reference("singleRef"), new KCallback<KObject[]>() {
                                    ...
                                    public void on(KObject[] b_cb) {
                                        ...
                                        a.setRef(A_Class.reference("singleRef"), b2, new KCallback() {
                                            @Override
                                            public void on(Object o) {
                                                a.ref(A_Class.reference("singleRef"), new KCallback<KObject[]>() {
                                                    @Override
                                                    public void on(KObject[] b2_cb) {
                                                        ...
                                                        a.setRef(A_Class.reference("singleRef"), null, new KCallback() {
                                                            @Override
                                                            public void on(Object o) {
                                                                a.ref(A_Class.reference("singleRef"), new KCallback<KObject[]>() {
                                                                    @Override
    ...
    public void A_multiRef() { // multi ref, not contained, no apposite
        ...
        a.add(A_Class.reference("multiRef"), b, new KCallback() {
            @Override
            public void on(Object o) {
                    ...
                    public void on(Object o) {
                        a.ref(A_Class.reference("multiRef"), new KCallback<KObject[]>() {
                            ...
                            public void on(KObject[] b_cb) {
                                ...
                                a.add(A_Class.reference("multiRef"), b2, new KCallback() {
                                    @Override
                                    public void on(Object o) {
                                        a.ref(A_Class.reference("multiRef"), new KCallback<KObject[]>() {
                                            @Override
                                                    ...
                                                    public void on(Object o) {
                                                        a.ref(A_Class.reference("multiRef"), new KCallback<KObject[]>() {
                                                            ...
                                                            public void on(KObject[] b_cb) {
                                                                ...
                                                                a.remove(A_Class.reference("multiRef"), b, new KCallback() {
                                                                    @Override
                                                                    public void on(Object o) {
                                                                        a.ref(A_Class.reference("multiRef"), new KCallback<KObject[]>() {
                                                                            @Override
                                                                                    ...
                                                                                    public void on(Object o) {
                                                                                        a.ref(A_Class.reference("multiRef"), new KCallback<KObject[]>() {
                                                                                            ...
                                                                                            public void on(KObject[] b_cb) {
                                                                                                ...
                                                                                                a.remove(A_Class.reference("multiRef"), b2, new KCallback() {
                                                                                                    @Override
                                                                                                    public void on(Object o) {
                                                                                                        a.ref(A_Class.reference("multiRef"), new KCallback<KObject[]>() {
                                                                                                            @Override
    ...
    public void singleA_singleB_Test() {  // single ref, contained, opposite
        ...
        //Set a in B
        b.setRef(B_Class.reference("singleA_singleB"), a, new KCallback() {
            @Override
            public void on(Object o) {
                                            ...
                                            public void on(KObject[] a_cb) {
                                                ...
                                                a.ref(A_Class.reference("singleA_singleB"), new KCallback<KObject[]>() {
                                                    ...
                                                    public void on(KObject[] b_cb) {
                                                        ...
                                                        b.setRef(B_Class.reference("singleA_singleB"), null, new KCallback() {
                                                            @Override
                                                            public void on(Object o) {
                                                                b.ref(B_Class.reference("singleA_singleB"), new KCallback<KObject[]>() {
                                                                    @Override
    ...
    public void singleA_multiB_Test() {
        ...
        b.add(B_Class.reference("singleA_multiB"), a, new KCallback() {
            @Override
            public void on(Object o) {
                                    ...
                                    public void on(KObject[] a_cb) {
                                        ...
                                        a.ref(A_Class.reference("singleA_multiB"), new KCallback<KObject[]>() {
                                            ...
                                            public void on(KObject[] b_cb) {
                                                ...
                                                b.add(B_Class.reference("singleA_multiB"), a2, new KCallback() {
                                                    @Override
                                                    public void on(Object o) {
                                                        b.ref(B_Class.reference("singleA_multiB"), new KCallback<KObject[]>() {
                                                            @Override
                                                                                ...
                                                                                b.add(B_Class.reference("singleA_multiB"), a2, new KCallback() {
                                                                                    ...
                                                                                    public void on(Object o) {
                                                                                        b.ref(B_Class.reference("singleA_multiB"), new KCallback<KObject[]>() {
                                                                                            ...
                                                                                            public void on(KObject[] a_cb) {
                                                                                                Assert.assertEquals(2, a_cb.length);
                                                                                                b.remove(B_Class.reference("singleA_multiB"), a, new KCallback() {
                                                                                                    @Override
                                                                                                    public void on(Object o) {
                                                                                                        b.ref(B_Class.reference("singleA_multiB"), new KCallback<KObject[]>() {
                                                                                                            @Override
                                                                                                                            ...
                                                                                                                            public void on(Object o) {
                                                                                                                                b.ref(B_Class.reference("singleA_multiB"), new KCallback<KObject[]>() {
                                                                                                                                    ...
                                                                                                                                    public void on(KObject[] a_cb) {
                                                                                                                                        ...
                                                                                                                                        //NOOP
                                                                                                                                        b.remove(B_Class.reference("singleA_multiB"), a2, new KCallback() {
                                                                                                                                            @Override
                                                                                                                                            public void on(Object o) {
                                                                                                                                                b.ref(B_Class.reference("singleA_multiB"), new KCallback<KObject[]>() {
                                                                                                                                                    @Override
    ...
    public void multiA_multiB_Test() {
        ...
        a.add(A_Class.reference("multiA_multiB"), b, new KCallback() {
            @Override
            public void on(Object o) {
                    ...
                    public void on(KObject[] a_cb) {
                        ...
                        a.ref(B_Class.reference("multiA_multiB"), new KCallback<KObject[]>() {
                            ...
                            public void on(KObject[] a_cb) {
                                ...
                                a.add(A_Class.reference("multiA_multiB"), b2, new KCallback() {
                                    @Override
                                    public void on(Object o) {
                                                    ...
                                                    public void on(KObject[] a_cb) {
                                                        ...
                                                        a.ref(B_Class.reference("multiA_multiB"), new KCallback<KObject[]>() {
                                                            ...
                                                            public void on(KObject[] a_cb) {
                                                                ...
                                                                b.add(B_Class.reference("multiA_multiB"), a, new KCallback() {
                                                                    @Override
                                                                    public void on(Object o) {
                                                                                    ...
                                                                                    public void on(KObject[] a_cb) {
                                                                                        ...
                                                                                        a.ref(B_Class.reference("multiA_multiB"), new KCallback<KObject[]>() {
                                                                                            ...
                                                                                            public void on(KObject[] a_cb) {
                                                                                                ...
                                                                                                b.add(B_Class.reference("multiA_multiB"), a2, new KCallback() {
                                                                                                    @Override
                                                                                                    public void on(Object o) {
                                                                                                        b.ref(B_Class.reference("multiA_multiB"), new KCallback<KObject[]>() {
                                                                                                            @Override
                                                                                                                            ...
                                                                                                                            public void on(KObject[] a_cb) {
                                                                                                                                ...
                                                                                                                                a2.ref(B_Class.reference("multiA_multiB"), new KCallback<KObject[]>() {
                                                                                                                                    ...
                                                                                                                                    public void on(KObject[] a_cb) {
                                                                                                                                        ...
                                                                                                                                        b2.add(B_Class.reference("multiA_multiB"), a2, new KCallback() {
                                                                                                                                            @Override
                                                                                                                                            public void on(Object o) {
                                                                                                                                                b.ref(B_Class.reference("multiA_multiB"), new KCallback<KObject[]>() {
                                                                                                                                                    @Override
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            public void on(KObject[] a_cb) {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                a2.ref(B_Class.reference("multiA_multiB"), new KCallback<KObject[]>() {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    public void on(KObject[] a_cb) {
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        //NOOP
                                                                                                                                                                                                                        b.remove(B_Class.reference("multiA_multiB"), a, new KCallback() {
                                                                                                                                                                                                                            @Override
                                                                                                                                                                                                                            public void on(Object o) {
                                                                                                                                                                                                                                b.ref(B_Class.reference("multiA_multiB"), new KCallback<KObject[]>() {
                                                                                                                                                                                                                                    @Override
